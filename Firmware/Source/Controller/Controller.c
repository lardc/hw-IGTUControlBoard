...
void CONTROL_InitStoragePointers()
{
	...
	STF_AssignPointer(7, (Int32U)&DataTable[REG_UGE_TH]);
	STF_AssignPointer(8, (Int32U)&DataTable[REG_IGES_RESULT]);
	STF_AssignPointer(9, (Int32U)&DataTable[REG_THERM_RESIS]);
	STF_AssignPointer(10, (Int32U)&DataTable[REG_DIAG_CURRENT]);
