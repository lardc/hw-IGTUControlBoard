...
#define TIME_RGLTR_PAUSE_RNG_SWITCH	10		// Пауза работы регулятора при переключении диапазонов тока Rth, в мс
											// нужна только для Rth, т.к. сигнал на потенциальных линиях пропадает
											// в момент смены диапазона тока
