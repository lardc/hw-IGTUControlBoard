...
void CU_LoadConvertParams()
{
	...
	CU_LoadSingleParams(&V_ADCtoIParams[MEASURE_V_I_LOW], REG_V_ADC_TO_I_LOW_B, REG_V_ADC_TO_I_LOW_K, REG_V_ADC_TO_I_LOW_P0, REG_V_ADC_TO_I_LOW_P1, REG_V_ADC_TO_I_LOW_P2);
	CU_LoadSingleParams(&V_ADCtoIParams[MEASURE_V_I_HIGH_R0], REG_V_ADC_TO_I_R0_B, REG_V_ADC_TO_I_R0_K, REG_V_ADC_TO_I_R0_P0, REG_V_ADC_TO_I_R0_P1, REG_V_ADC_TO_I_R0_P2);
	CU_LoadSingleParams(&V_ADCtoIParams[MEASURE_V_I_HIGH_R1], REG_V_ADC_TO_I_R1_B, REG_V_ADC_TO_I_R1_K, REG_V_ADC_TO_I_R1_P0, REG_V_ADC_TO_I_R1_P1, REG_V_ADC_TO_I_R1_P2);
