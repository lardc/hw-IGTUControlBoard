...
#define VGS_RING_BUFFER_THRESHOLD			500			// мкс, лимит считывани€ данных из кольцевого буфера, ниже которого будут значени€ вне полки
...
void VGS_Process()
{
	...
	{
		if (FlatTopActive) // ѕроверка при условии падении значени€ при достижении плоской вершины
			FlatTopActive = false;
