...
//
#define REG_DAC_C_C_SET_P1				30	// Коэффициент тонкой подстройки Р1 x1000
#define REG_DAC_C_C_SET_P0				31	// Смещение тонкой подстройки Р0
//
#define REG_DAC_V_V_SET_P1				33	// Коэффициент тонкой подстройки Р1 x1000
#define REG_DAC_V_V_SET_P0				34	// Смещение тонкой подстройки Р0
//
#define REG_C_V_CUTOFF_P1				36	// Коэффициент тонкой подстройки Р1 x1000
#define REG_C_V_CUTOFF_P0				37	// Смещение тонкой подстройки Р0
//
#define REG_C_V_NEGATIVE_P1				39	// Коэффициент тонкой подстройки Р1 x1000
#define REG_C_V_NEGATIVE_P0				40	// Смещение тонкой подстройки Р0
//
