...
#define REG_U_G_P2						0	// Коэффициент тонкой подстройки Р2
#define REG_U_G_P1						1	// Коэффициент тонкой подстройки Р1
#define REG_U_G_P0						2	// Смещение тонкой подстройки Р0
#define REG_U_G_K						3	// Коэффициент преобразования K
#define REG_U_G_B						4	// Коэффициент преобразования B
//
#define REG_U_POT_P2					5	// Коэффициент тонкой подстройки Р2
#define REG_U_POT_P1					6	// Коэффициент тонкой подстройки Р1
#define REG_U_POT_P0					7	// Смещение тонкой подстройки Р0
#define REG_U_POT_K						8	// Коэффициент преобразования K
#define REG_U_POT_B						9	// Коэффициент преобразования B
//
#define REG_I_0_P2						10	// Коэффициент тонкой подстройки Р2
#define REG_I_0_P1						11	// Коэффициент тонкой подстройки Р1
#define REG_I_0_P0						12	// Смещение тонкой подстройки Р0
#define REG_I_0_K						13	// Коэффициент преобразования K
#define REG_I_0_B						14	// Коэффициент преобразования B
#define REG_I_0_RSH						15	// Сопротивление шунта
//
#define REG_I_1_P2						16	// Коэффициент тонкой подстройки Р2
#define REG_I_1_P1						17	// Коэффициент тонкой подстройки Р1
#define REG_I_1_P0						18	// Смещение тонкой подстройки Р0
#define REG_I_1_K						19	// Коэффициент преобразования K
#define REG_I_1_B						20	// Коэффициент преобразования B
#define REG_I_1_RSH						21	// Сопротивление шунта
//
#define REG_I_2_P2						22	// Коэффициент тонкой подстройки Р2
#define REG_I_2_P1						23	// Коэффициент тонкой подстройки Р1
#define REG_I_2_P0						24	// Смещение тонкой подстройки Р0
#define REG_I_2_K						25	// Коэффициент преобразования K
#define REG_I_2_B						26	// Коэффициент преобразования B
#define REG_I_2_RSH						27	// Сопротивление шунта
//
#define REG_I_3_P2						28	// Коэффициент тонкой подстройки Р2
#define REG_I_3_P1						29	// Коэффициент тонкой подстройки Р1
#define REG_I_3_P0						30	// Смещение тонкой подстройки Р0
#define REG_I_3_K						31	// Коэффициент преобразования K
#define REG_I_3_B						32	// Коэффициент преобразования B
#define REG_I_3_RSH						33	// Сопротивление шунта
//
#define REG_I_4_P2						34	// Коэффициент тонкой подстройки Р2
#define REG_I_4_P1						35	// Коэффициент тонкой подстройки Р1
#define REG_I_4_P0						36	// Смещение тонкой подстройки Р0
#define REG_I_4_K						37	// Коэффициент преобразования K
#define REG_I_4_B						38	// Коэффициент преобразования B
#define REG_I_4_RSH						39	// Сопротивление шунта
//
#define REG_I_5_P2						40	// Коэффициент тонкой подстройки Р2
#define REG_I_5_P1						41	// Коэффициент тонкой подстройки Р1
#define REG_I_5_P0						42	// Смещение тонкой подстройки Р0
#define REG_I_5_K						43	// Коэффициент преобразования K
#define REG_I_5_B						44	// Коэффициент преобразования B
#define REG_I_5_RSH						45	// Сопротивление шунта
//
#define REG_I_6_P2						46	// Коэффициент тонкой подстройки Р2
#define REG_I_6_P1						47	// Коэффициент тонкой подстройки Р1
#define REG_I_6_P0						48	// Смещение тонкой подстройки Р0
#define REG_I_6_K						49	// Коэффициент преобразования K
#define REG_I_6_B						50	// Коэффициент преобразования B
#define REG_I_6_RSH						51	// Сопротивление шунта
//
#define REG_I_7_P2						52	// Коэффициент тонкой подстройки Р2
#define REG_I_7_P1						53	// Коэффициент тонкой подстройки Р1
#define REG_I_7_P0						54	// Смещение тонкой подстройки Р0
#define REG_I_7_K						55	// Коэффициент преобразования K
#define REG_I_7_B						56	// Коэффициент преобразования B
#define REG_I_7_RSH						57	// Сопротивление шунта
// 58
#define REG_U_ADC_REF					59	// Опорное напряжение ADC/DAC, в В
